// Exhibit #0032: interpolating a log message instead of using a template
...
// The charge failed; we log it the way it reads most naturally in an editor.
...
// The line is right there in plain text, but the field to query by never existed.
if (hits != 1)
{
