// Exhibit #0027: splitting a set with two opposite comparisons
...
// The worker splits the queue in two: run now, or wait.
var dueNow = queue.Where(i => i.NextRetryAt <= 0).ToList();
