// Exhibit #0009: enumerating the same LINQ query twice
...
int headerCount = premium.Count(); // enumeration #1
...
int printed = 0;
foreach (var product in premium) // enumeration #2 - the recipe runs again
{
